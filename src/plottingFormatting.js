      ...
      <ResponsiveContainer width="95%" aspect={1.5}>
        ...
        >
          ...
          <YAxis 
            ...
            type = "number"
            tickFormatter={priceFormatter}
            label={{value: 'Value', angle: -90, fill : 'white', fontSize: '1.75vw', dx: 30, dy: 30, font: 'Arial'}}
          />
      ...
      <ResponsiveContainer width="95%" aspect={1.5}>
        ...
        >
          ...
          <YAxis
            stroke= {'white'}
            type = "number"
            label={{value: 'Percent spend', angle: -90, fill : 'white', fontSize: '1.75vw', position: "relative", dx: 30, font: 'Arial'}}
            tickFormatter={(item)=>item+"%"}
          />
          <Legend content = {getNothing}/>
